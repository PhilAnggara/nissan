...
@section('content')
  ...
  <div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">Aset Peralatan Bengkel</h1>

      <!-- Search -->
    {{-- <form class="d-none d-sm-inline-block form-inline mr-3 ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="GET" action="{{ route('peralatan.index') }}">
      ...
      <a type="button" target="_blank" class="btn btn-info ml-2" href="{{ route('cetak-peralatan') }}">
            ...
            <div class="card-body">
              <form action="{{ route('peralatan.store') }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="jenis_aset" placeholder="Jenis Aset" value="{{ old('jenis_aset') }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="nilai_buku" placeholder="Nilai Buku" value="{{ old('nilai_buku') }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="status" placeholder="Status di Laporan Keuangan" value="{{ old('status') }}">
                </div>
